...
│   │   ├── TeamExplorer.tsx         # Team comparison radar
│   │   ├── ModelDashboard.tsx       # ML model results
│   │   ├── KeyFindings.tsx          # 6 insight cards
│   │   ├── PredictTheWinner.tsx     # Interactive quiz
│   │   ├── ParticleArena.tsx        # Three.js background
│   │   ├── Navigation.tsx           # Sticky nav bar
│   │   └── Footer.tsx               # Footer
│   ├── data/
│   │   └── tournament.ts            # All tournament data
│   └── lib/
│       └── assets.ts                # Team logo + hero icon helpers
├── package.json
├── tailwind.config.ts               # Custom Dota 2 theme
├── tsconfig.json
└── next.config.mjs
```
...
The analytical backbone comes from a Jupyter notebook (`dota2_team_analysis.ipynb`) that:

1. **Fetches** pro match data from the [OpenDota API](https://www.opendota.com/)
2. **Engineers** two composite features:
   - **Synergy Index** — Team win rate + experience + draft consistency
   - **Tempo Index** — Early-game win rate + side control + game closure speed
3. **Trains** two models:
   - **Logistic Regression** — Baseline (AUC: 0.684)
   - **XGBoost** — Gradient boosted trees (AUC: 0.716)
4. **Validates** via 5-fold cross-validation (CV-AUC: 0.700 ± 0.034)
5. **Predicts** the Grand Final: Team Liquid 61.2% — **Correct!**

### Feature Importance (XGBoost)

| Feature | Importance | Coefficient |
|---------|-----------|-------------|
| Synergy Index | **34.2%** | +0.451 |
| Tempo Index | 29.8% | +0.389 |
| Match Duration | 21.4% | -0.267 |
| Side Advantage | 14.6% | +0.198 |
...
<table>
  <tr>
    <td align="center" width="45%">
      <img src="public/teams/liquid.png" width="60"/><br/>
      <strong>Team Liquid</strong><br/>
      <h2>3</h2>
    </td>
    <td align="center" width="10%"><strong>vs</strong></td>
    <td align="center" width="45%">
      <img src="public/teams/navi.png" width="60"/><br/>
      <strong>Natus Vincere</strong><br/>
      <h2>1</h2>
    </td>
  </tr>
</table>

**Game 4 — The Championship Clincher (45:12)**
- Liquid's synergy-driven drafts dismantled NaVi's tempo gameplan
- 34-11 kill score, 19,800 peak gold lead
- miCKe & Nisha named co-MVPs of the series

> *"Liquid didn't just play fast — they played together."*
...
| Source | Usage |
|--------|-------|
| [Liquipedia](https://liquipedia.net/dota2/) | Tournament structure, hero pick/ban data (top 5) |
| [OpenDota API](https://www.opendota.com/) | Pro match data for ML model training |
| [Valve CDN](https://cdn.cloudflare.steamstatic.com/) | Official hero minimap icons |
| Analytical Estimates | Extended hero meta, team synergy/tempo indices |

---

## 📝 License

This project is for educational and analytical purposes. Dota 2 is a registered trademark of Valve Corporation. Team logos belong to their respective organizations.

---

<p align="center">
  <strong>Built with data, designed with passion.</strong><br/>
  <sub>BLAST Slam VI — Malta 2026</sub>
</p>
