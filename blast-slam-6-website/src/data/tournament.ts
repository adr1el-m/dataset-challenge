...
export const goldTimeline = {
  ...
  teamA: "Team Liquid",
  teamB: "Natus Vincere",
  matchContext: "Grand Final — Game 4 (32:17)",
  ...
  killDiff:   [0, 1, 0, 0, 1, 2, 3, 2, 1, 1, 3, 4, 6, 8, 10, 12, 13],
  towerDiff:  [0, 0, 0, 0, 0, 1, 1, 2, 2, 1, 1, 3, 4, 5, 6, 8, 9],
  liquidNetWorth: [625, 1800, 3200, 4800, 6500, 8800, 11200, 14500, 17200, 19800, 22800, 26300, 29800, 33200, 37100, 41500, 45200],
  naviNetWorth:   [625, 2000, 3800, 5600, 6300, 7600, 9400, 11000, 14000, 17700, 20000, 22200, 24700, 27400, 30200, 33300, 35800],
  gamePhases: [
  ...
  events: [
    { minute: 0.25, text: "0:15 First blood (miCKe → pma)", type: "radiant" as const, icon: "💥" },
    { minute: 7.27, text: "7:16 Wisdom fight won by NaVi (Nisha + miCKe die)", type: "dire" as const, icon: "⚔️" },
    { minute: 7.58, text: "7:35 NaVi top T1 falls", type: "radiant" as const, icon: "🏹" },
    { minute: 11.08, text: "11:05 NaVi mid T1 falls", type: "radiant" as const, icon: "🗼" },
    { minute: 16.75, text: "16:45 NaVi bottom T1 falls", type: "radiant" as const, icon: "🏹" },
    { minute: 18.5, text: "18:30 Liquid bottom T1 falls", type: "dire" as const, icon: "🏹" },
    { minute: 19.18, text: "19:11 Liquid take Aegis", type: "radiant" as const, icon: "🛡️" },
    { minute: 20.18, text: "20:11 Smoke fight near top portal — Liquid win", type: "radiant" as const, icon: "💨" },
    { minute: 21.42, text: "21:25 Liquid mid T1 falls", type: "dire" as const, icon: "🏹" },
    { minute: 22.38, text: "22:23 NaVi bottom T2 falls", type: "radiant" as const, icon: "🏰" },
    { minute: 23.1, text: "23:06 NaVi mid T2 falls", type: "radiant" as const, icon: "🏰" },
    { minute: 24.32, text: "24:19 NaVi top T2 falls", type: "radiant" as const, icon: "🏰" },
    { minute: 28.77, text: "28:46 NaVi top T3 falls", type: "radiant" as const, icon: "🏰" },
    { minute: 29.62, text: "29:37 Rosh fight — Liquid wipe NaVi", type: "radiant" as const, icon: "⚔️" },
    { minute: 30.77, text: "30:46 NaVi mid T3 + mid/top rax fall", type: "radiant" as const, icon: "🏰" },
    { minute: 31.53, text: "31:32 Liquid take Roshan", type: "radiant" as const, icon: "🛡️" },
    { minute: 32.28, text: "32:17 NaVi call GG", type: "radiant" as const, icon: "🏆" },
  ],
  summary: {
    duration: "32:17",
    liquidKills: 33,
    ...
    peakGoldLeadMin: 32,
    turningPointMin: 20,
    turningPointText: "Liquid win the top portal smoke fight and convert into Tier 2 pressure",
